...
function ProductFormDialog({ isOpen, onOpenChange, onSave, product, title, nextProductId }: ProductFormDialogProps) {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        const productToSave: Product = {
            ...
            salePrice: formData.isOnSale ? (Number(formData.salePrice) || 0) : null,
            imageUrl: finalImageUrl,
        };
        
        // This is a type cast because the server action handles the conversion
        // from number to string for the database.
        onSave(productToSave as any);
        setIsUploading(false);
    };
