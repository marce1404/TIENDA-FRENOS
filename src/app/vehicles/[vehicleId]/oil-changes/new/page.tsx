...
export default function AddOilChangePage() {
  ...
  const { addOilChange } = useOilChanges(vehicleId);
  ...
  if (!vehicleName || vehicleName === "Vehículo no encontrado") {
     return (
      <div className="text-center py-10">
        ...
        <p className="text-muted-foreground mb-6">El vehículo para el que intentas agregar un cambio de aceite no existe.</p>
  ...
  return (
    <div className="space-y-6">
      ...
      <h1 className="text-2xl font-semibold text-center">Agregar Cambio de Aceite para <span className="text-primary">{vehicleName}</span></h1>
      <OilChangeForm onSubmit={handleSubmit} submitButtonText="Agregar" />
    </div>
  );
}
